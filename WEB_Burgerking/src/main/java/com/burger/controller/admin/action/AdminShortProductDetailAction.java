...
public class AdminShortProductDetailAction implements Action {
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String url = "admin/product/shortproductDetail.jsp";
		...
		if(avo == null) { 
			...
			String kindList2[] = {"0", "Large set", "Set", "Single", "Menu List"}; // 검색해온 상품에서 kind 값 추출 & 상품의 kind 값을 정수로 변환
			int index3 = Integer.parseInt(pvo.getKind3());
			String useynList[] = {"0", "사용", "미사용"};
			int index2 = Integer.parseInt(pvo.getUseyn());
