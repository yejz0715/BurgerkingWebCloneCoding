...
<div class="bg_w">
	<div class="web_container1">
		<div class="subtitWrap">
			...
			<div class="tab01" >
			<ul>
				<li><a href="burger.do?command=nonDeliveryForm&kind1=1">
					<button type="button" ><span>스페셜&amp;할인팩</span></button></a></li>
				<li><a href="burger.do?command=nonDeliveryForm&kind1=2">
					<button type="button"><span>프리미엄</span></button></a></li>
				<li><a href="burger.do?command=nonDeliveryForm&kind1=3">
					<button type="button"><span>와퍼</span></button></a></li>
				<li><a href="burger.do?command=nonDeliveryForm&kind1=4">
					<button type="button"><span>주니어&amp;버거</span></button></a></li>
				<li><a href="burger.do?command=nonDeliveryForm&kind1=5">
					<button type="button"><span>올데이킹&amp;치킨버거</span></button></a></li> 
				<li><a href="burger.do?command=nonDeliveryForm&kind1=6">
					<button type="button"><span>사이드</span></button></a></li>
				<li><a href="burger.do?command=nonDeliveryForm&kind1=7">
					<button type="button"><span>음료&amp;디저트</span></button></a></li>
				<li><a href="burger.do?command=nonDeliveryForm&kind1=8">
		...
		<div class="menuarea">
			<ul>
				...
				<c:choose>
					...
					<li><a onclick="deliveryDetail('${productVO.pseq}')">
