...
<article>
	...
	<div class="webAddress">
		<form method="post" name="address" action="burger.do">
			<input type="hidden" name="command" value="myAddressUpdate" />
			<fieldset>
				<legend>MY배달지</legend>
				<label>Zip Code</label><input type="text" name="zip_num" size="10" value="${MyAddressVO.zip_num}">
				<input type="button" value="주소 찾기" onclick="post_zip()"><br>
				<label>Address</label><input type="text" name="addr1" size="50" value="${addr1}"><br>
				<label>&nbsp;</label><input type="text" name="addr2" size="25" value="${addr2}">
				<br>
			</fieldset>
