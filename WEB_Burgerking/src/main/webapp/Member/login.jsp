				...
				<div class="cont">
					...
					<div class="c_btn item2">
						<input type="submit" class="btn01 m red"
							onclick="return login_chk();" value="로그인"></input> <input
							type="button" class="btn01 m"
							onclick="location.href='burger.do?command=joinForm'" value="회원가입" />
					</div>
					<div class="login_menu">
						<a href="burger.do?command=findIdForm"><span>아이디 찾기</span></a> <a
							href="burger.do?command=findPwdForm"><span>비밀번호 찾기</span></a>
					</div>
				</div>
			</form>
