	...
	<div class="web_container1">
		<div class="tab_cont">
			<div class="faq_category">
				...
				<label class="switch01">
					<input type="radio" name="faqcategory" checked="checked" onclick="location.href='burger.do?command=faqForm&fnum=2'">
					<span>제품/품질/서비스</span>
				</label>
				<label class="switch01">
				...
				<label class="switch01">
					<input type="radio"	 name="faqcategory" onclick="location.href='burger.do?command=faqForm&fnum=4'">
					<span>임대 / 가맹</span>
				</label>
				<label class="switch01">
